...
require("lazy").setup({
	...
	-- },
	{
		...
		dependencies = {
			{ "neovim/nvim-lspconfig" }, -- 这个插件只提供LSP的默认配置
			{ "mason-org/mason-lspconfig.nvim" }, -- 此包解决lspconfig插件里面的包名和mason包名存在差异的问题
		},
	},
	{
		"folke/neodev.nvim",
	...
	{
		"catppuccin/nvim",
		name = "catppuccin", -- 插件别名（方便引用）
		cond = enabled(group, "catppuccin"), -- 关联用户配置中的启用开关
		config = function()
			require("plugin-configs.catppuccin") -- 加载你的配置文件
		end,
	},
	{
	...
	},
	{
		...
		-- cond = enabled(group, "typescriptTools"),
